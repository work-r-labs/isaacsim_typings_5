...
class fabricarray(warp.types.noncontiguous_array_base):
    ...
    def __getitem__(self, key):
        ...
    def __init__(self, data = None, attrib = None, dtype = typing.Any, ndim = None):
        ...
    def __len__(self):
        ...
    def __str__(self):
