...
_file_open_dict: collections.OrderedDict  # value = OrderedDict([('usd', FileOpenAction(name='usd', open_fn=<function open_stage at 0x7031479caca0>, matching_type=1)), ('Open Python Script Handler', FileOpenAction(name='Open Python Script Handler', open_fn=<function Extension._add_content_browser_ui.<locals>.<lambda> at 0x703147694c20>, matching_type=<function Extension._add_content_browser_ui.<locals>.<lambda> at 0x703147695760>)), ('Convert to USD', FileOpenAction(name='Convert to USD', open_fn=<function AssetImporterExtension._register_menus.<locals>.<lambda> at 0x703147201a80>, matching_type=<bound method AssetImporterExtension._is_show_open_visible of <omni.kit.tool.asset_importer.extension.AssetImporterExtension object>>))])
