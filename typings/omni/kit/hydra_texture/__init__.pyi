...
from carb import deprecated as _deprecated
import omni as omni
...
class Extension(omni.ext._extensions.IExt):
    ...
    def on_startup(self):
        ...
def _get_drawable_ldr_resource(*args, **kwargs):
    ...
def _get_imgui_reference(*args, **kwargs):
    ...
def acquire_hydra_texture_factory_interface(*args, **kwargs):
    ...
