...
__all__: list = ['FileEventModel', 'get_latest_urls_from_event_queue', 'get_last_url_visited', 'get_last_url_opened', 'get_last_url_saved', 'reset_file_event_queue', 'asset_types', 'FILE_OPENED_GLOBAL_EVENT', 'FILE_OPENED_EVENT', 'FILE_SAVED_GLOBAL_EVENT', 'FILE_SAVED_EVENT', 'FILE_EVENT_QUEUE_UPDATED_GLOBAL_EVENT', 'FILE_EVENT_QUEUE_UPDATED']
...
def get_last_url_visited(asset_type: str = None, tag: str = None) -> str:
    ...
    """
def get_latest_urls_from_event_queue(num_latest: int = 1, asset_type: str = None, event_type: int = 0, event_name: str = None, tag: str = None) -> typing.List[str]:
    """
