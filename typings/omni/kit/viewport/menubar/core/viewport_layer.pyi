...
class MenuBarViewportLayer:
    ...
    def _build_fn(self):
        ...
    def _menu_changed(self, model: <function singleton.<locals>.getinstance at 0x703144507420>, item: omni.kit.viewport.menubar.core.menu_item.viewport_menu_item.ViewportMenuItem) -> None:
        ...
    def destroy(self):
        ...
    @property
