...
_name_to_menuitem: dict  # value = {'__DEFAULT__MENUBAR__': <omni.kit.viewport.menubar.core.menu_item.viewport_menubar_item.ViewportMenubar object>, '<omni.kit.viewport.menubar.core.menu_item.viewport_menu_spacer.ViewportMenuSpacer object>': <omni.kit.viewport.menubar.core.menu_item.viewport_menu_spacer.ViewportMenuSpacer object>, 'SyntheticData': <omni.syntheticdata.scripts.menu.SynthDataMenuContainer object>, 'Lighting': <omni.kit.viewport.menubar.lighting.menu_container.MenuContainer object>, 'Camera': <omni.kit.viewport.menubar.camera.camera_menu_container.CameraMenuContainer object>, 'Renderer': <omni.kit.viewport.menubar.render.renderer_menu_container.RendererMenuContainer object>, 'Settings': <omni.kit.viewport.menubar.settings.setting_menu_container.SettingMenuContainer object>, 'Display': <omni.kit.viewport.menubar.display.display_menu_container.DisplayMenuContainer object>}
_parentname_to_name: collections.defaultdict  # value = defaultdict(<class 'list'>, {None: ['__DEFAULT__MENUBAR__'], '__DEFAULT__MENUBAR__': ['<omni.kit.viewport.menubar.core.menu_item.viewport_menu_spacer.ViewportMenuSpacer object>', 'SyntheticData', 'Lighting', 'Camera', 'Renderer', 'Settings', 'Display']})
