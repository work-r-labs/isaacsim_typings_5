...
__all__: list[str] = ['MaterialBindingWidget', 'UsdShadeAttributeWidget', 'UsdShadeMaterialWidget', 'UsdShadeNodeGraphWidget', 'UsdShadeShaderWidget', 'UsdUIBackdropWidget', 'backdrop_widget', 'get_binding_from_prims', 'material_binding', 'remove_properties_and_connections', 'usdshade']
