...
import pathlib
import sys as sys
__all__: list[str] = ['BrowserBar', 'ICON_PATH', 'PathField', 'StringQueueModel', 'UI_STYLES', 'VisitedHistory', 'os', 'sys', 'ui']
class BrowserBar:
    """
    ...
    def path(self) -> str:
        ...
        """
ICON_PATH: pathlib.PosixPath  # value = PosixPath('/home/chris/videos/isaacsim/_build/linux-x86_64/release/extscache/omni.kit.widget.browser_bar-2.0.10+8131b85d/icons')
