...
from omni import ui
import omni.ui._ui
__all__: list[str] = ['AbstractBrowserModel', 'BrowserWidget', 'CategoryDelegate', 'CategoryItem', 'CategoryView', 'ChildrenModelWrapper', 'CollectionItem', 'CollectionModelWrapper', 'DETAIL_VIEW_PADDING', 'DetailDelegate', 'DetailItem', 'OverviewView', 'SingleLevelWrapper', 'ThumbnailView', 'UI_STYLES', 'ZoomBar', 'carb', 'ui']
class BrowserWidget:
    """
