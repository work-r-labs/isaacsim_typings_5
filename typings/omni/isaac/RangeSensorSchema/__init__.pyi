...
import pxr.UsdGeom
import typing
__all__: list[str] = ['Generic', 'Lidar', 'RangeSensor', 'Tokens', 'UltrasonicArray', 'UltrasonicEmitter', 'UltrasonicFiringGroup', 'UltrasonicMaterialAPI']
...
class Tokens(Boost.Python.instance):
    Generic: typing.ClassVar[str] = 'Generic'
    Lidar: typing.ClassVar[str] = 'Lidar'
    RangeSensor: typing.ClassVar[str] = 'RangeSensor'
    UltrasonicArray: typing.ClassVar[str] = 'UltrasonicArray'
    UltrasonicEmitter: typing.ClassVar[str] = 'UltrasonicEmitter'
    UltrasonicFiringGroup: typing.ClassVar[str] = 'UltrasonicFiringGroup'
    UltrasonicMaterialAPI: typing.ClassVar[str] = 'UltrasonicMaterialAPI'
