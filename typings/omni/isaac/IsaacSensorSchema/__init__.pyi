...
import pxr.UsdGeom
import typing
__all__: list[str] = ['IsaacBaseSensor', 'IsaacContactSensor', 'IsaacImuSensor', 'IsaacLightBeamSensor', 'IsaacRtxLidarSensorAPI', 'IsaacRtxRadarSensorAPI', 'Tokens']
...
class Tokens(Boost.Python.instance):
    IsaacBaseSensor: typing.ClassVar[str] = 'IsaacBaseSensor'
    IsaacContactSensor: typing.ClassVar[str] = 'IsaacContactSensor'
    IsaacImuSensor: typing.ClassVar[str] = 'IsaacImuSensor'
    IsaacLightBeamSensor: typing.ClassVar[str] = 'IsaacLightBeamSensor'
    IsaacRtxLidarSensorAPI: typing.ClassVar[str] = 'IsaacRtxLidarSensorAPI'
    IsaacRtxRadarSensorAPI: typing.ClassVar[str] = 'IsaacRtxRadarSensorAPI'
