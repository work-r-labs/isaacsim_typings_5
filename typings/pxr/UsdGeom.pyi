...
import pxr.Usd
import typing
__all__ = ['BBoxCache', 'BasisCurves', 'Boundable', 'Camera', 'Capsule', 'Cone', 'ConstraintTarget', 'Cube', 'Curves', 'Cylinder', 'Gprim', 'HermiteCurves', 'Imageable', 'LinearUnits', 'Mesh', 'ModelAPI', 'MotionAPI', 'NurbsCurves', 'NurbsPatch', 'Plane', 'PointBased', 'PointInstancer', 'Points', 'Primvar', 'PrimvarsAPI', 'Scope', 'Sphere', 'Subset', 'Tokens', 'VisibilityAPI', 'Xform', 'XformCache', 'XformCommonAPI', 'XformOp', 'XformOpTypes', 'Xformable']
class BBoxCache(Boost.Python.instance):
    ...
    **untransformed"object"space** bounds for component-models. In the
    ...
    def __init__(*args, **kwargs):
        ...
        __init__(time, includedPurposes, useExtentsHint, ignoreVisibility)
...
class NurbsCurves(Curves):
    ...
    **Form** is provided as an aid to interchange between modeling and
    ...
    __instance_size__: typing.ClassVar[int] = 40
    @staticmethod
    def CreateFormAttr(*args, **kwargs):
        """
...
class XformOp(Boost.Python.instance):
    ...
    **On packing order of rotateABC triples**  The order in which the axis
    ...
    def __init__(*args, **kwargs):
        ...
        __init__(attr, isInverseOp, arg3)
