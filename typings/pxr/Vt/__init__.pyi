...
import typing
__all__: list[str] = ['BoolArray', 'CharArray', 'DoubleArray', 'DualQuatdArray', 'DualQuatfArray', 'DualQuathArray', 'FloatArray', 'HalfArray', 'Int64Array', 'IntArray', 'IntervalArray', 'Matrix2dArray', 'Matrix2fArray', 'Matrix3dArray', 'Matrix3fArray', 'Matrix4dArray', 'Matrix4fArray', 'QuatdArray', 'QuaternionArray', 'QuatfArray', 'QuathArray', 'Range1dArray', 'Range1fArray', 'Range2dArray', 'Range2fArray', 'Range3dArray', 'Range3fArray', 'Rect2iArray', 'ShortArray', 'StringArray', 'TokenArray', 'UCharArray', 'UInt64Array', 'UIntArray', 'UShortArray', 'Vec2dArray', 'Vec2fArray', 'Vec2hArray', 'Vec2iArray', 'Vec3dArray', 'Vec3fArray', 'Vec3hArray', 'Vec3iArray', 'Vec4dArray', 'Vec4fArray', 'Vec4hArray', 'Vec4iArray']
...
class _ValueWrapper(Boost.Python.instance):
    ...
    def __str__(*args, **kwargs):
        ...
__MFB_FULL_PACKAGE_NAME: str = 'vt'
