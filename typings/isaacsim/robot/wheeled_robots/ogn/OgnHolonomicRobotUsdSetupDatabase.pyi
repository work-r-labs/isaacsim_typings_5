...
class OgnHolonomicRobotUsdSetupDatabase(omni.graph.core._impl.database.Database):
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_setting_locked', 'robotPrimPath', 'usePath', '_batchedReadAttributes', 'comPrimPath'}
        comPrim = ...
        comPrimPath = ...
        robotPrim = ...
        robotPrimPath = ...
    ...
    class ValuesForOutputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'upAxis', 'wheelAxis', '_batchedWriteValues'}
        mecanumAngles = ...
        upAxis = ...
        wheelAxis = ...
        wheelDofNames = ...
