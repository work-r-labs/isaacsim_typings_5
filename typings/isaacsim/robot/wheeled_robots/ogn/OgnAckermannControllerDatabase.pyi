...
import typing
__all__: list[str] = ['OgnAckermannControllerDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnAckermannControllerDatabase(omni.graph.core._impl.database.Database):
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'invertSteering', 'frontWheelRadius', 'steeringAngleVelocity', 'execIn', '_setting_locked', 'dt', 'acceleration', 'trackWidth', 'backWheelRadius', 'maxWheelRotation', '_batchedReadValues', 'maxSteeringAngleVelocity', 'wheelBase', 'maxWheelVelocity', 'speed', 'steeringAngle', '_batchedReadAttributes', 'maxAcceleration'}
        acceleration = ...
        backWheelRadius = ...
        dt = ...
        execIn = ...
