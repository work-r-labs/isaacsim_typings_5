...
import isaacsim.robot.wheeled_robots.ogn.python.nodes.OgnStanleyControlPID
...
import typing
__all__: list[str] = ['OgnStanleyControlPIDDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnStanleyControlPIDDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'targetChanged', 'gains', 'target', 'currentPosition', '_batchedReadValues', 'wheelBase', 'currentOrientation', 'execIn', 'thresholds', '_batchedReadAttributes', '_setting_locked', 'currentSpeed', 'maxVelocity', 'step', 'drawPath'}
        currentOrientation = ...
        currentPosition = ...
        currentSpeed = ...
        drawPath = ...
    ...
    class ValuesForOutputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'execOut', 'angularVelocity', 'linearVelocity', '_batchedWriteValues'}
        angularVelocity = ...
        execOut = ...
        linearVelocity = ...
        def __getattr__(self, item: str):
    ...
    NODE_TYPE_CLASS = isaacsim.robot.wheeled_robots.ogn.python.nodes.OgnStanleyControlPID.OgnStanleyControlPID
    @staticmethod
    def deregister():
        ...
    @staticmethod
