...
__all__: list[str] = ['OgnSurfaceGripperDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnSurfaceGripperDatabase(omni.graph.core._impl.database.Database):
    ...
    Helper class providing simplified access to data on nodes of type isaacsim.robot.surface_gripper.SurfaceGripper
        ...
        Attribute Value Properties:
            Inputs:
                inputs.SurfaceGripper
                inputs.Toggle
                inputs.enabled
        
    """
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', 'enabled', '_setting_locked', 'Toggle'}
        SurfaceGripper = ...
        Toggle = ...
        enabled = ...
