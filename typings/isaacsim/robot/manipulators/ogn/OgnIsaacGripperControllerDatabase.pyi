...
__all__: list[str] = ['OgnIsaacGripperControllerDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnIsaacGripperControllerDatabase(omni.graph.core._impl.database.Database):
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', 'close', 'stop', '_setting_locked', 'open', 'execIn'}
