...
import time as time
import typing
__all__: list[str] = ['ProximitySensor', 'ProximitySensorManager', 'Sdf', 'Usd', 'UsdGeom', 'carb', 'clear_sensors', 'get_physx_scene_query_interface', 'get_prim_at_path', 'get_world_transform_matrix', 'np', 'omni', 'register_sensor', 'time']
...
class ProximitySensorManager:
    _instance: typing.ClassVar[ProximitySensorManager]  # value = <isaacsim.sensors.physx.impl.proximity_sensor.ProximitySensorManager object>
