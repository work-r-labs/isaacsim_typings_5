...
import typing
__all__ = ['OgnIsaacPrintRTXSensorInfoDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback']
class OgnIsaacPrintRTXSensorInfoDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    NODE_TYPE_CLASS = isaacsim.sensors.rtx.ogn.python.nodes.OgnIsaacPrintRTXSensorInfo.OgnIsaacPrintRTXSensorInfo
    @staticmethod
    def deregister():
        ...
    @staticmethod
