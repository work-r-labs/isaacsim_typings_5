...
import typing
import warp as wp
__all__: list[str] = ['DiskLight', 'Light', 'Usd', 'UsdLux', 'np', 'ops_utils', 'stage_utils', 'wp']
class DiskLight(isaacsim.core.experimental.objects.impl.lights.light.Light):
    """
    High level class for creating/wrapping USD Disk Light (light emitted from one side of a circular disk) prims.
        ...
        Args:
            ...
            radii: Radii (disk's radius) (shape ``(N, 1)``).
        ...
        .. code-block:: python
            ...
            >>> prims = DiskLight(paths)  # doctest: +NO_CHECK
