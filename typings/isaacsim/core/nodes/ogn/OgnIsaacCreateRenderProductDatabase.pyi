...
import carb as carb
import isaacsim.core.nodes.ogn.python.nodes.OgnIsaacCreateRenderProduct
...
__all__: list[str] = ['OgnIsaacCreateRenderProductDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnIsaacCreateRenderProductDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', 'enabled', '_setting_locked', 'width', 'height', 'execIn'}
        cameraPrim = ...
        enabled = ...
        execIn = ...
        height = ...
    ...
    NODE_TYPE_CLASS = isaacsim.core.nodes.ogn.python.nodes.OgnIsaacCreateRenderProduct.OgnIsaacCreateRenderProduct
    @staticmethod
    def deregister():
        ...
    @staticmethod
