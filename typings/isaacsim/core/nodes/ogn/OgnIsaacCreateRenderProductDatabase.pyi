...
__all__ = ['OgnIsaacCreateRenderProductDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnIsaacCreateRenderProductDatabase(omni.graph.core._impl.database.Database):
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_setting_locked', 'width', '_batchedReadValues', 'execIn', 'height', 'enabled', '_batchedReadAttributes'}
        cameraPrim = ...
        enabled = ...
        execIn = ...
        height = ...
