...
__all__: list[str] = ['OgnIsaacSetCameraOnRenderProductDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnIsaacSetCameraOnRenderProductDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', 'renderProductPath', '_setting_locked', 'execIn'}
        cameraPrim = ...
        execIn = ...
        renderProductPath = ...
    ...
    NODE_TYPE_CLASS = isaacsim.core.nodes.ogn.python.nodes.OgnIsaacSetCameraOnRenderProduct.OgnIsaacSetCameraOnRenderProduct
    @staticmethod
    def deregister():
        ...
    @staticmethod
