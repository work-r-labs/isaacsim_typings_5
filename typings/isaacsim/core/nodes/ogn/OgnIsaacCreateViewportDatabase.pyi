...
import carb as carb
import isaacsim.core.nodes.ogn.python.nodes.OgnIsaacCreateViewport
...
import typing
__all__: list[str] = ['OgnIsaacCreateViewportDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback']
class OgnIsaacCreateViewportDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', '_setting_locked', 'viewportId', 'name', 'execIn'}
        execIn = ...
        name = ...
        viewportId = ...
    ...
    class ValuesForOutputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'execOut', '_batchedWriteValues', 'viewport'}
        execOut = ...
        viewport = ...
        def __getattr__(self, item: str):
            ...
    ...
    NODE_TYPE_CLASS = isaacsim.core.nodes.ogn.python.nodes.OgnIsaacCreateViewport.OgnIsaacCreateViewport
    @staticmethod
    def deregister():
        ...
    @staticmethod
