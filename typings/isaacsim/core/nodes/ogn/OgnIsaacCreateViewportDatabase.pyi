...
import typing
__all__ = ['OgnIsaacCreateViewportDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback']
class OgnIsaacCreateViewportDatabase(omni.graph.core._impl.database.Database):
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_setting_locked', 'name', 'viewportId', 'execIn', '_batchedReadValues', '_batchedReadAttributes'}
        execIn = ...
        name = ...
        viewportId = ...
    ...
    class ValuesForOutputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'execOut', 'viewport', '_batchedWriteValues'}
        execOut = ...
        viewport = ...
        def __getattr__(self, item: str):
            ...
