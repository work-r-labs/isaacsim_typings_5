...
import isaacsim.core.nodes.ogn.python.nodes.OgnIsaacArticulationController
...
__all__: list[str] = ['OgnIsaacArticulationControllerDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnIsaacArticulationControllerDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', '_setting_locked', 'execIn', 'robotPath'}
        effortCommand = ...
        execIn = ...
        jointIndices = ...
        jointNames = ...
    ...
    NODE_TYPE_CLASS = isaacsim.core.nodes.ogn.python.nodes.OgnIsaacArticulationController.OgnIsaacArticulationController
    @staticmethod
    def deregister():
        ...
    @staticmethod
