...
import typing
__all__: list[str] = ['OgnIsaacTestNodeDatabase', 'carb', 'og', 'ogn', 'sys', 'traceback']
class OgnIsaacTestNodeDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', 'input', '_batchedReadAttributes', '_setting_locked', 'execIn'}
        execIn = ...
        input = ...
    ...
    NODE_TYPE_CLASS = isaacsim.core.nodes.ogn.python.nodes.OgnIsaacTestNode.OgnIsaacTestNode
    @staticmethod
    def deregister():
        ...
    @staticmethod
