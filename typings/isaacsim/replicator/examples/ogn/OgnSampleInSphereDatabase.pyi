...
import isaacsim.replicator.examples.ogn.python.nodes.OgnSampleInSphere
...
__all__ = ['OgnSampleInSphereDatabase', 'og', 'ogn', 'sys', 'traceback', 'usdrt']
class OgnSampleInSphereDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', 'radius', '_setting_locked', 'execIn', '_batchedReadAttributes'}
        execIn = ...
        prims = ...
        radius = ...
    ...
    NODE_TYPE_CLASS = isaacsim.replicator.examples.ogn.python.nodes.OgnSampleInSphere.OgnSampleInSphere
    @staticmethod
    def deregister():
        ...
    @staticmethod
