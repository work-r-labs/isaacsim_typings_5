...
import isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnWritePhysicsArticulationView
...
import typing
__all__: list[str] = ['OgnWritePhysicsArticulationViewDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnWritePhysicsArticulationViewDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    NODE_TYPE_CLASS = isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnWritePhysicsArticulationView.OgnWritePhysicsArticulationView
    @staticmethod
    def deregister():
        ...
    @staticmethod
