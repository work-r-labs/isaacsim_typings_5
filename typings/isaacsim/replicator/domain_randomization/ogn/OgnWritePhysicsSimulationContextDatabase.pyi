...
import isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnWritePhysicsSimulationContext
...
import typing
__all__: list[str] = ['OgnWritePhysicsSimulationContextDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnWritePhysicsSimulationContextDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', 'on_reset', 'prims', 'distribution', 'attribute', 'execIn', '_batchedReadAttributes', '_setting_locked', 'num_buckets', 'operation'}
        attribute = ...
        dist_param_1 = ...
        dist_param_2 = ...
        distribution = ...
    ...
    NODE_TYPE_CLASS = isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnWritePhysicsSimulationContext.OgnWritePhysicsSimulationContext
    @staticmethod
    def deregister():
        ...
    @staticmethod
