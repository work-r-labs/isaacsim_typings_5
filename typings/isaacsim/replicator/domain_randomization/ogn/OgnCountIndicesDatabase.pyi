...
import isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnCountIndices
...
import typing
__all__: list[str] = ['OgnCountIndicesDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnCountIndicesDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForOutputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedWriteValues', 'count'}
        count = ...
    ...
    NODE_TYPE_CLASS = isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnCountIndices.OgnCountIndices
    @staticmethod
    def deregister():
        ...
    @staticmethod
