...
import isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnRandom3f
...
import typing
__all__: list[str] = ['OgnRandom3fDatabase', 'numpy', 'og', 'ogn', 'sys', 'traceback']
class OgnRandom3fDatabase(omni.graph.core._impl.database.Database):
    """
    ...
    class ValuesForInputs(omni.graph.core._impl.database.DynamicAttributeAccess):
        LOCAL_PROPERTY_NAMES: typing.ClassVar[set] = {'_batchedReadValues', '_batchedReadAttributes', 'minimum', '_setting_locked', 'maximum'}
        maximum = ...
        minimum = ...
    ...
    NODE_TYPE_CLASS = isaacsim.replicator.domain_randomization.ogn.python.nodes.OgnRandom3f.OgnRandom3f
    @staticmethod
    def deregister():
        ...
    @staticmethod
