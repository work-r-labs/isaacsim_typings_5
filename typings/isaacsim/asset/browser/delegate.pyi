...
__all__: list[str] = ['AssetBrowserModel', 'AssetDetailDelegate', 'CURRENT_PATH', 'ContextMenu', 'DetailItem', 'FolderDetailDelegate', 'ICON_PATH', 'Path', 'asyncio', 'carb', 'create_drop_helper', 'omni', 'ui']
class AssetDetailDelegate(omni.kit.browser.folder.core.widgets.folder_detail_delegate.FolderDetailDelegate):
    ...
    def on_right_click(self, item: omni.kit.browser.core.models.browser_item.DetailItem) -> None:
        ...
        Show context menu
        """
CURRENT_PATH: pathlib.PosixPath  # value = PosixPath('/home/chris/videos/isaacsim/_build/linux-x86_64/release/exts/isaacsim.asset.browser/isaacsim/asset/browser')
ICON_PATH: pathlib.PosixPath  # value = PosixPath('/home/chris/videos/isaacsim/_build/linux-x86_64/release/exts/isaacsim.asset.browser/icons')
