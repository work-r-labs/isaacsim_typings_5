...
__all__: list[str] = ['BUTTON_BG_COLOR', 'BUTTON_WIDTH', 'COLOR_W', 'COLOR_X', 'COLOR_Y', 'COLOR_Z', 'DISABLED_LABEL_COLOR', 'EXTENSION_FOLDER_PATH', 'FONT_SIZE', 'FRAME_BG_COLOR', 'FRAME_HEAD_COLOR', 'HEADER_FONT_SIZE', 'HORIZONTAL_SPACING', 'LABEL_COLOR', 'LABEL_TITLE_COLOR', 'LABEL_WIDTH', 'LINE_COLOR', 'STRING_FIELD_LABEL_COLOR', 'TREEVIEW_BG_COLOR', 'TREEVIEW_HEADER_BG_COLOR', 'TREEVIEW_ITEM_COLOR', 'TREEVIEW_ITEM_FONT', 'TREEVIEW_SELECTED_COLOR', 'TRIANGLE_COLOR', 'UNIT_COLOR', 'VERTICAL_SPACING', 'carb', 'cl', 'get_icons_path', 'get_option_style', 'get_style', 'omni', 'pathlib', 'ui']
...
EXTENSION_FOLDER_PATH: pathlib.PosixPath  # value = PosixPath('/home/chris/videos/isaacsim/_build/linux-x86_64/release/exts/isaacsim.asset.importer.urdf')
FONT_SIZE: int = 14
