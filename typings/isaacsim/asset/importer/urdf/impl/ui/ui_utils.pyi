...
import sys as sys
__all__: list[str] = ['BUTTON_WIDTH', 'COLOR_W', 'COLOR_X', 'COLOR_Y', 'COLOR_Z', 'FilePickerDialog', 'LABEL_HEIGHT', 'LABEL_WIDTH', 'SearchListItem', 'SearchListItemDelegate', 'SearchListItemModel', 'SimpleCheckBox', 'add_folder_picker_btn', 'add_folder_picker_icon', 'add_line_rect_flourish', 'add_separator', 'asyncio', 'btn_builder', 'build_header', 'build_info_frame', 'build_simple_search', 'carb', 'cb_builder', 'checkbox_builder', 'color_picker_builder', 'combo_cb_dropdown_builder', 'combo_cb_plot_builder', 'combo_cb_scrolling_frame_builder', 'combo_cb_str_builder', 'combo_cb_xyz_plot_builder', 'combo_floatfield_slider_builder', 'combo_intfield_slider_builder', 'dropdown_builder', 'float_builder', 'float_field_builder', 'format_tt', 'get_option_style', 'get_style', 'inf', 'int_builder', 'multi_btn_builder', 'multi_cb_builder', 'multi_dropdown_builder', 'omni', 'on_copy_to_clipboard', 'on_docs_link_clicked', 'on_open_IDE_clicked', 'on_open_folder_clicked', 'os', 'plot_builder', 'progress_bar_builder', 'scrolling_frame_builder', 'setup_ui_headers', 'state_btn_builder', 'str_builder', 'string_filed_builder', 'subprocess', 'sys', 'ui', 'xyz_builder', 'xyz_plot_builder']
...
def btn_builder(label = '', type = 'button', text = 'button', tooltip = '', on_clicked_fn = None):
    ...
    """
def build_header(ext_path, file_path, title = 'My Custom Extension', doc_link = 'https://docs.omniverse.nvidia.com/app_isaacsim/app_isaacsim/overview.html'):
    """
...
def scrolling_frame_builder(label = '', type = 'scrolling_frame', default_val = 'No Data', tooltip = ''):
    ...
    """
def setup_ui_headers(ext_id, file_path, title = 'My Custom Extension', doc_link = 'https://docs.omniverse.nvidia.com/app_isaacsim/app_isaacsim/overview.html', overview = ''):
    """
...
def state_btn_builder(label = '', type = 'state_button', a_text = 'STATE A', b_text = 'STATE B', tooltip = '', on_clicked_fn = None):
    ...
    """
def str_builder(label = '', type = 'stringfield', default_val = ' ', tooltip = '', on_clicked_fn = None, use_folder_picker = False, read_only = False, item_filter_fn = None, bookmark_label = None, bookmark_path = None, folder_dialog_title = 'Select Output Folder', folder_button_title = 'Select Folder', style = None):
    """
    ...
    """
def string_filed_builder(default_val = ' ', tooltip = '', read_only = False, item_filter_fn = None, folder_dialog_title = 'Select Output Folder', folder_button_title = 'Select Folder', bookmark_label = '', bookmark_path = '', use_folder_picker = True):
    """
    Creates a Stylized Stringfield Widget
